...
''' <summary>
''' 7 '"Включение Форсажа РУД67 -> РУД115 (106)"
''' </summary>
Friend Class AnalysisВключениеФорсажаРУД67_РУД115
    Inherits Analysis
    ...
    Private Sub AllocateProtocol()
        ...
        PopulateProtocol(10, {"Заброс N1 от устан. значения", "Нет", ""})
        PopulateProtocol(11, {"Заброс N1 от КРД", "Нет", GetEngineNormTUParameter(12)})
        PopulateProtocol(12, {"Заброс N2 от КРД", "Нет", GetEngineNormTUParameter(13)})
        PopulateProtocol(13, {"Провал N1 от устан. значения", "Нет", ""})
        PopulateProtocol(14, {"Провал N2 от устан. значения", "Нет", ""})
        PopulateProtocol(15, {"dN=dN1прев.+dN2пров.", "% в ТУ", GetEngineNormTUParameter(16)})
        PopulateProtocol(16, {"Заброс Ттвг", "Нет", GetEngineNormTUParameter(36)})
    End Sub
    ...
    Public Overrides Sub DecodingRegimeSnapshot()
        ...
        ' провал N2относительно установившегося
        parameter = conN2
