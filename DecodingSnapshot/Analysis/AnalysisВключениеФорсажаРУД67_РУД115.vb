...
Friend Class AnalysisВключениеФорсажаРУД67_РУД115
    ...
    Private Sub AllocateProtocol()
        ...
        Protocol(13, 1) = "Провал N1 от устан. значения"
        Protocol(14, 1) = "Провал N2 от устан. значения"
        Protocol(15, 1) = "dN=dN1прев.+dN2пров."
        Protocol(16, 1) = "Заброс Ттвг"
        ...
        Protocol(13, 3) = ""
        Protocol(14, 3) = ""
        Protocol(15, 3) = GetEngineNormTUParameter(16)
        Protocol(16, 3) = GetEngineNormTUParameter(36)
    End Sub
    ...
    Public Overrides Sub DecodingRegimeSnapshot()
        ...
        Else
            ...
            With clsДлительностьЗабросаПровалаТ4
                ...
                End If
                Protocol(16, 2) = parameter & ":заброс=" & dblЗабросT4 & " гр."
            End With
        End If
        ...
        Else
            ...
            With clsПровалN2ОтносительноУстановившегося
                ...
                Protocol(14, 2) = parameter & ":уст. провал=" & Round(.DeltaA, 2) & " %"
            End With
        End If
